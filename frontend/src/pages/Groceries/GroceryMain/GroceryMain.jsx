...
import './GroceryMain.css'
import { StarFill } from 'react-bootstrap-icons';
import { Link } from 'react-router-dom';

export function GroceryMain() {
    return (
        <div>
            <div className='car_main_container'>
                <div className='row' >
                    <div className='col-4' >
                        <Link to="/upscale">
                            <img src='./images/g1.jpg' className='car_images' />
                        </Link>
                        <div className='row mt-3'>
                            <div className='col-8'>
                                <span><b>Penny stocks</b></span>
                            </div>
                            <div className='col-2'>
                        ...
                        <div className='row'>
                            <div className='col-8'>
                                <p> A total of 50,841 individual investors received the Al prediction report and succeeded. Stock prices and charts.</p>
                            </div>
                    ...
                    <div className='col-4' >
                        ...
                        <img src='./images/g2.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
                    ...
                    <div className='col-4' >
                        <img src='./images/g3.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
            ...
            <div className='car_main_container'>
                <div className='row' >
                    <div className='col-4' >
                        ...
                        <img src='./images/g4.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
