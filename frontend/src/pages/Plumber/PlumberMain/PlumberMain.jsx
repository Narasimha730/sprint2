...
import './PlumberMain.css'
export function PlumberMain() {
    return (
        <div>
                ...
                <div className='row' >
                    <div className='col-4' >
                        <Link to="/riseup">
                            ...
                            <img src='./images/plumberheader.jpg' className='car_images' />
                        </Link>
                        ...
                        <div className='row'>
                            <div className='col-8'>
                                <p>Plumbing regulations are plentiful in Dubai, yet they are not always adhered to. </p>
                            </div>
                    ...
                    <div className='col-4' >
                        ...
                        <img src='./images/plumber1.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
                    ...
                    <div className='col-4' >
                        ...
                        <img src='./images/plumber2.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
            ...
            <div className='car_main_container'>
                <div className='row' >
                    <div className='col-4' >
                        ...
                        <img src='./images/plumber3.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
