...
// export function Gogaga() {

//     return (
//         <div className='car'>
//             <img src="./images/travel1.jpg" className='carimage' />
//             <div className='car_info'>
//                 <h3>Dnata Travels. <span className='car_ratings'>4.5<StarFill></StarFill></span>
//                 </h3>
...
export function Gogaga() {
    ...
    const handleSubmit = async e => {
        e.preventDefault();
        try {
            await axios.post('http://localhost:7000/api/bookings/travel', formData);
            alert('your travel ticket booked successfully..!');
            setFormData({
                name: '',
                email: '',
                address: '',
            ...
            console.error('Error booking groceries:', error);
