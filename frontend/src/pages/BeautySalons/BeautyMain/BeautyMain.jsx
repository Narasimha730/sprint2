                ...
                <div className='row' >
                    <div className='col-4' >
                        <Link to="/lounge">
                            ...
                            <img src='./images/beautyimg1.jpg' className='car_images' />
                        </Link>
                        ...
                        <div className='row'>
                            <div className='col-8'>
                                <p>Premium Beauty Salon in Dubai - Top Quality Hair Extensions at Zieda Beauty Lounge. Book your</p>
                            </div>
                    ...
                    <div className='col-4' >
                        ...
                        <img src='./images/beautyimg2.png' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
                    ...
                    <div className='col-4' >
                        ...
                        <img src='./images/beautyimage4.jpg' className='car_images' />
                        <div className='row mt-3'>
                            <div className='col-8'>
