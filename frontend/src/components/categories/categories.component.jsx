                        ...
                        <div className='row ' style={{ width: "100%" }}>
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/carmain" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/carlogo.jpg" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/fitnessCenters" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/fitnesslogo.avif" className='restaurant' />
                                    <h6 style={{ marginLeft: "15px", fontFamily: " sans-serif" }}>Fitness Center</h6>
                                </Link>
                            </div>
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/beautysalons" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/beautylogo.jpg" className='restaurant' />
                                    <h6 style={{ marginLeft: "18px", fontFamily: " sans-serif" }}>Beauty Salons</h6>
                                </Link>
                            </div>

                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/plumber" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/plumberlogo.jpg" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/travel" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/travellogo.jpg" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/restaurant-main" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/homelogo.png" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/grocery" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/grocerylogo.webp" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/electrician" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/electricianlogo.jpg" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/restaurant-main" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/bankslogo.jpg" className='restaurant' />
                                    <h6 style={{ marginLeft: "16px", fontFamily: " sans-serif" }}>Banks</h6>
                                </Link>
                            </div>
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/restaurant-main" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/atmlogo.jpg" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/restaurant-main" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/hotellogo.jpg" className='restaurant' />
                            ...
                            <div className='mt-4 col-sm-6 col-md-2  ' style={{ alignItems: "center" }}>
                                <Link to="/restaurant-main" style={{ textDecoration: 'none', color: 'black' }}>
                                    <img src="./images/schoollogo.jpg" className='restaurant' />
